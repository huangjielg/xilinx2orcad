...
proc ::capGUIUtils::capAddNetsToPart {} {
    ...
    while {$lPin != $lNullObj } {
        ...
        set newname $lPinNumber 
        append newname "_" [DboTclHelper_sGetConstCharPtr $lPinName]
        puts "lPinNumber: $lPinNumber $newname"
        ::capGUIUtils::capAddNetToPin $lPin  $newname
